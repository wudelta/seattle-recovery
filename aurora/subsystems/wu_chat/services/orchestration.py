...
from aurora.subsystems.wu_chat.services.hansel_continuation import (
    execute_hansel_continuation,
)
...
# ======================================================================
# START: WU_SYNCHRONOUS_ORCHESTRATION
# ======================================================================
...
def process_wu_logic_synchronous(
    ...
    try:
        ...
        continuation_result = execute_hansel_continuation(
            runner=runner,
            initial_task_input=compiled_task_notes,
            original_task=user_delta_notes,
            user=user,
        )
        ...
        complete_response_text = continuation_result[
            "wu_response"
        ]
        hansel_navigation = continuation_result[
            "hansel_navigation"
        ]
...
# ======================================================================
# END: WU_SYNCHRONOUS_ORCHESTRATION
# ======================================================================
