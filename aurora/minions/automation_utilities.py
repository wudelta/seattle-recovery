...
class WorkspaceAutomationRunner:
    """Handles low-overhead shell script creation tasks for page and api resources."""
    ...
    async def execute_page_command(self, page_name: str) -> bool:
        ...
        try:
            ...
            def update_registry():
                # FIX: Realigned fields to match schema definitions ('name' and 'persona' choices)
    ...
    async def execute_api_command(self, api_name: str) -> bool:
        """
        Executes the /api command macro: generates an empty asynchronous Django backend
        view file, configures registry paths, and hooks tracking channels.
        """
        try:
