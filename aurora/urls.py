...
urlpatterns = [
    ...
    path(
        "api/engineering_session/",
        api_endpoints.engineering_session_endpoint,
        name="engineering_session_endpoint",
    ),
    path(
        "api/planning/",
...
# ======================================================================
# END: SYSTEM_DISPATCH_ROUTING_MATRIX_AND_LOGIN_ENTRIES
# ======================================================================