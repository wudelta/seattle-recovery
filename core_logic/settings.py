...
import os
from neomodel import config as neomodel_config # REVERTED: Restored legacy v5 global config dictionary wrapper
...
DATABASES = {
    'default': {
        ...
        'HOST': env('DB_HOST', default='seattle_postgres'), # Target internal postgres container service name
...
NEO4J_HOST = env('NEO4J_HOST', default='seattle_neo4j') # FIXED: Reads dedicated NEO4J_HOST tracking variable
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "hosts": [("redis_broker", 6379)], # UPGRADED: Routes via the internal Redis container hostname
        },
    },
}
